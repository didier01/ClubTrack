...
public class RegistryUserActivity extends AppCompatActivity {
    ...
    private static final String TAG = RegistryUserActivity.class.getSimpleName();
    ...
    View.OnClickListener goNext = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            if (edtName.getText().length() == 0) {
                ...
                Log.d(TAG, "el correo no es valido");
                return;
                ...
                Log.e(TAG, "el correo ya esta en uso");
                return;
                ...
                Log.d(TAG, "el nombre de usuario ya existe");
                return;
